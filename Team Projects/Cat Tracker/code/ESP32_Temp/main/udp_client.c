...
double readTemp(void) {
    ...
    double steinhart = 1 / (log(resistance / 10000) * (1 / 3950.0) + (1 / 298.15)) - 273.15;
    printf("Raw: %ld\tVoltage: %ldmV   \tThermistor resistance: %lf\tTemperature: %lf\n", adc_reading, voltage, resistance, steinhart);
    return steinhart;
}
...
static const char *TAG = "ESP32_Temp_Client";
